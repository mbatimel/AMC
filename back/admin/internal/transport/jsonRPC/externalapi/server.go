...
func (srv *Server) WithLog() *Server {
	if srv.httpAdminAPI != nil {
		srv.httpAdminAPI = srv.AdminAPI().WithLog()
	}
	return srv
}
...
func (srv *Server) WithMetrics() *Server {
	...
	if srv.httpAdminAPI != nil {
		srv.httpAdminAPI = srv.AdminAPI().WithMetrics()
	}
	return srv
}

func (srv *Server) AdminAPI() *httpAdminAPI {
	return srv.httpAdminAPI
}
