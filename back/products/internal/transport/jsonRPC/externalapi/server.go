...
type Server struct {
	...
	httpProductsAPI *httpProductsAPI
...
func (srv *Server) WithLog() *Server {
	if srv.httpProductsAPI != nil {
		srv.httpProductsAPI = srv.ProductsAPI().WithLog()
	}
	return srv
}
...
func (srv *Server) WithMetrics() *Server {
	...
	if srv.httpProductsAPI != nil {
		srv.httpProductsAPI = srv.ProductsAPI().WithMetrics()
	}
	return srv
}

func (srv *Server) ProductsAPI() *httpProductsAPI {
	return srv.httpProductsAPI
}
