...
type Server struct {
	...
	httpProductsInternalAPI *httpProductsInternalAPI
...
func (srv *Server) WithLog() *Server {
	if srv.httpProductsInternalAPI != nil {
		srv.httpProductsInternalAPI = srv.ProductsInternalAPI().WithLog()
	}
	return srv
}
...
func (srv *Server) WithMetrics() *Server {
	...
	if srv.httpProductsInternalAPI != nil {
		srv.httpProductsInternalAPI = srv.ProductsInternalAPI().WithMetrics()
	}
	return srv
}

func (srv *Server) ProductsInternalAPI() *httpProductsInternalAPI {
	return srv.httpProductsInternalAPI
}
