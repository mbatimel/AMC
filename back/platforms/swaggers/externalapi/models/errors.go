...
type Err400 struct {
	...
	// @tg example=`content.api.errors.platforms.badRequest`
...
type Err401 struct {
	...
	Error bool `json:"error"`
	// @tg desc=`Заголовок ошибки`
	// @tg example=`content.api.errors.platforms.unauthorized`
	ErrorText string `json:"errorText"`
...
type Err403 struct {
	...
	Error bool `json:"error"`
	// @tg desc=`Заголовок ошибки`
	// @tg example=`content.api.errors.platforms.accessDenied`
	ErrorText string `json:"errorText"`
...
type Err500 struct {
	...
	Error bool `json:"error"`
	// @tg desc=`Заголовок ошибки`
	// @tg example=`content.api.errors.platforms.internalError`
	ErrorText string `json:"errorText"`
