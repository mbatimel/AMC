...
type Server struct {
	...
	httpPlatformsAPI *httpPlatformsAPI
...
func (srv *Server) WithLog() *Server {
	if srv.httpPlatformsAPI != nil {
		srv.httpPlatformsAPI = srv.PlatformsAPI().WithLog()
	}
	return srv
}
...
func (srv *Server) WithMetrics() *Server {
	...
	if srv.httpPlatformsAPI != nil {
		srv.httpPlatformsAPI = srv.PlatformsAPI().WithMetrics()
	}
	return srv
}

func (srv *Server) PlatformsAPI() *httpPlatformsAPI {
	return srv.httpPlatformsAPI
}
