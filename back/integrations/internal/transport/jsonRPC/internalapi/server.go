...
type Server struct {
	...
	httpOnecOrdersAPI *httpOnecOrdersAPI
...
func (srv *Server) WithLog() *Server {
	if srv.httpOnecOrdersAPI != nil {
		srv.httpOnecOrdersAPI = srv.OnecOrdersAPI().WithLog()
	}
	return srv
}
...
func (srv *Server) WithMetrics() *Server {
	...
	if srv.httpOnecOrdersAPI != nil {
		srv.httpOnecOrdersAPI = srv.OnecOrdersAPI().WithMetrics()
	}
	return srv
}

func (srv *Server) OnecOrdersAPI() *httpOnecOrdersAPI {
	return srv.httpOnecOrdersAPI
}
