...
func (srv *Server) WithLog() *Server {
	if srv.httpUsersAPI != nil {
		srv.httpUsersAPI = srv.UsersAPI().WithLog()
	}
	return srv
}
...
func (srv *Server) WithMetrics() *Server {
	...
	if srv.httpUsersAPI != nil {
		srv.httpUsersAPI = srv.UsersAPI().WithMetrics()
	}
	return srv
}

func (srv *Server) UsersAPI() *httpUsersAPI {
	return srv.httpUsersAPI
}
