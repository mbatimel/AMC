...
func (srv *Server) WithLog() *Server {
	if srv.httpAuthAPI != nil {
		srv.httpAuthAPI = srv.AuthAPI().WithLog()
	}
	return srv
}
...
func (srv *Server) WithMetrics() *Server {
	...
	if srv.httpAuthAPI != nil {
		srv.httpAuthAPI = srv.AuthAPI().WithMetrics()
	}
	return srv
}

func (srv *Server) AuthAPI() *httpAuthAPI {
	return srv.httpAuthAPI
}
