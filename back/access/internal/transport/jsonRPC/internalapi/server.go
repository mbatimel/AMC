...
func (srv *Server) WithLog() *Server {
	if srv.httpAccessAPI != nil {
		srv.httpAccessAPI = srv.AccessAPI().WithLog()
	}
	return srv
}
...
func (srv *Server) WithMetrics() *Server {
	...
	if srv.httpAccessAPI != nil {
		srv.httpAccessAPI = srv.AccessAPI().WithMetrics()
	}
	return srv
}

func (srv *Server) AccessAPI() *httpAccessAPI {
	return srv.httpAccessAPI
}
