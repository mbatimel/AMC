...
func (srv *Server) WithLog() *Server {
	if srv.httpOrdersAPI != nil {
		srv.httpOrdersAPI = srv.OrdersAPI().WithLog()
	}
	return srv
}
...
func (srv *Server) WithMetrics() *Server {
	...
	if srv.httpOrdersAPI != nil {
		srv.httpOrdersAPI = srv.OrdersAPI().WithMetrics()
	}
	return srv
}

func (srv *Server) OrdersAPI() *httpOrdersAPI {
	return srv.httpOrdersAPI
}
